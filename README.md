...
<li><a href='https://github.com/hebabkb/Deep-Learning-for-Anti-Money-Laundering-Detecting-Suspicious-Transactions/tree/main/TemporalGNN'>TemporalGNN</a>: Contains notebooks and results for the Temporal Graph Neural Network model.</li>
    <ul>
        ...
        <li><a href='https://github.com/hebabkb/Deep-Learning-for-Anti-Money-Laundering-Detecting-Suspicious-Transactions/tree/main/TemporalGNN/temporalgnn.ipynb'>temporalgnn.ipynb</a>: Jupyter notebook containing step by step TGNN model building with results</li>
        <li><a href='https://github.com/hebabkb/Deep-Learning-for-Anti-Money-Laundering-Detecting-Suspicious-Transactions/tree/main/TemporalGNN/model_pipeline.sh'>model_pipeline.sh</a>: Shell script to run the entire TGNN model pipeline including preprocessing, training, and evaluation</li>
    </ul>
